 ...
 {
  document.getElementById('ctl00_Main_MAddress').focus();
  document .getElementById('ctl00_Main_MAddress').select();
 }

 //搜索蜘蛛、机器人模拟获取文本焦点
 function GetRobotfocus()
 {
  document.getElementById('ctl00_Main_RAddress').focus();
  document.getElementById('ctl00_Main_RAddress').select();
 }
...
//网页Gzip压缩检测
 ...
 {
   document.getElementById('ctl00_Main_Hddress').focus();
    document.getElementById('ctl00_Main_Hddress').select();
 }
 //百度近日收录情况查询
 function GetBaidu()
{
