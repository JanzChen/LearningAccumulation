...
function openEditWin() {
    var url = path + "/common/setConditions.do";
    var options = {
        width : 500,
        height : 400,
        iconCls : "icon-config",
...
function setConditions(conditions) {
    ...
    _this.init = function() {
        ...
        _this.buildCondition(defaultConditions);
    };
    _this.getConditions = function() {
        return conditions;
    };
    _this.getDefaultConditions = function() {
        return defaultConditions;
    };
    _this.buildCondition = function(conditions) {
        ...
        $(conditions).each(
                function() {
                    if ("textbox" == this.type) {
                        ...
                        html.push('	<label class="label x-form-item-label">'
                                + this.text + '：</label>');
                        ...
                        html.push('	<input id="' + this.id + '" name="'
                                ...
                                + this.min + '" increment="' + this.increment
                                + '" max="' + this.max + '"/>');
                        html.push('</li>');
    ...
    _this.setCss = function() {
        ...
        $("#searchDiv").find("ul").find("li").find(".easyui-numberspinner")
                .css({
                    width : "126px"
                });
        var selectObj = $("#searchDiv").find("ul").find("li").find("select");
